...
export default function ContactPage() {
  return (
    <div className="max-w-container mx-auto px-4 w-full overflow-x-hidden py-12 pt-8 max-w-2xl mx-auto">
      <h1 className="text-4xl text-accent dark:text-[#4fc3f7] mb-8 pb-2 border-b border-accent dark:border-[#4fc3f7]">お問い合わせ</h1>
