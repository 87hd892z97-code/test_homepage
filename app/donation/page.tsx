    ...
    <div className="max-w-container mx-auto px-4 w-full overflow-x-hidden py-12 pt-8 max-w-2xl mx-auto">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 mt-8 max-mobile:grid-cols-2 max-mobile:gap-4 max-[480px]:grid-cols-1 max-[480px]:gap-3">
          <div className="bg-white p-8 rounded-xl shadow-md text-center border-2 border-transparent transition-all duration-300 ease hover:border-accent hover:-translate-y-0.5 max-mobile:p-6 max-[480px]:p-4">
      ...
      <section className="bg-gray-100 p-8 rounded-xl text-center mb-12 max-mobile:p-6 max-[480px]:p-4">
        ...
        <div className="flex gap-4 justify-center mt-8">
          <a href="/concerts" className="inline-block bg-white text-accent border border-accent px-8 py-4 rounded-lg no-underline font-normal transition-all duration-300 ease hover:bg-accent hover:text-white hover:-translate-y-0.5">演奏会情報を見る</a>
        </div>
      </section>
